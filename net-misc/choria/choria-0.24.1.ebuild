...
EGO_SUM=(
	...
	"github.com/Freman/eventloghook v0.0.0-20191003051739-e4d803b6b48b/go.mod"
	...
	"github.com/achanda/go-sysctl v0.0.0-20160222034550-6be7678c45d2/go.mod"
	"github.com/aelsabbahy/GOnetstat v0.0.0-20160428114218-edf89f784e08"
	"github.com/aelsabbahy/GOnetstat v0.0.0-20160428114218-edf89f784e08/go.mod"
	"github.com/aelsabbahy/go-ps v0.0.0-20201009164808-61c449472dcf"
	"github.com/aelsabbahy/go-ps v0.0.0-20201009164808-61c449472dcf/go.mod"
	"github.com/aelsabbahy/goss v0.3.16"
	"github.com/aelsabbahy/goss v0.3.16/go.mod"
	...
	"github.com/awesome-gocui/gocui v1.0.1/go.mod"
	...
	"github.com/choria-io/go-updater v0.0.3/go.mod"
	...
	"github.com/guptarohit/asciigraph v0.5.2/go.mod"
	...
	"github.com/looplab/fsm v0.3.0/go.mod"
	...
	"github.com/nats-io/jsm.go v0.0.27-0.20210913145213-1aa453c3cd08/go.mod"
	"github.com/nats-io/jwt v1.2.2"
	"github.com/nats-io/jwt v1.2.2/go.mod"
	"github.com/nats-io/jwt/v2 v2.0.3"
	"github.com/nats-io/jwt/v2 v2.0.3/go.mod"
	"github.com/nats-io/nats-server/v2 v2.3.3/go.mod"
	"github.com/nats-io/nats-server/v2 v2.4.1-0.20210907200628-874c79fe411f/go.mod"
	"github.com/nats-io/nats-server/v2 v2.5.1-0.20210921161523-29037a4f5cd6"
	"github.com/nats-io/nats-server/v2 v2.5.1-0.20210921161523-29037a4f5cd6/go.mod"
	"github.com/nats-io/nats-streaming-server v0.22.1"
	"github.com/nats-io/nats-streaming-server v0.22.1/go.mod"
	"github.com/nats-io/nats.go v1.11.0/go.mod"
	"github.com/nats-io/nats.go v1.11.1-0.20210623165838-4b75fc59ae30/go.mod"
	"github.com/nats-io/nats.go v1.12.0/go.mod"
	"github.com/nats-io/nats.go v1.12.2-0.20210916222008-92921544b891/go.mod"
	"github.com/nats-io/nats.go v1.12.3"
	"github.com/nats-io/nats.go v1.12.3/go.mod"
	...
	"github.com/nats-io/stan.go v0.10.0/go.mod"
	...
	"github.com/oleiade/reflections v0.0.0-20160817071559-0e86b3c98b2f/go.mod"
	...
	"github.com/open-policy-agent/opa v0.32.1/go.mod"
	"github.com/opencontainers/runc v0.0.0-20161107232042-8779fa57eb4a"
	"github.com/opencontainers/runc v0.0.0-20161107232042-8779fa57eb4a/go.mod"
	...
	"github.com/prometheus/procfs v0.7.1/go.mod"
	...
	"github.com/tadglines/go-pkgs v0.0.0-20140924210655-1f86682992f1/go.mod"
	"github.com/tidwall/gjson v1.9.1"
	"github.com/tidwall/gjson v1.9.1/go.mod"
	...
	"github.com/urfave/cli v0.0.0-20161102131801-d86a009f5e13/go.mod"
	...
	"github.com/xiam/to v0.0.0-20191116183551-8328998fc0ed/go.mod"
...
SRC_URI="https://github.com/choria-io/go-choria/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
